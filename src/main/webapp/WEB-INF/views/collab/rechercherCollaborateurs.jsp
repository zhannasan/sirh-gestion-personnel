...
<body>
	<header>
		<nav class="navbar navbar-expand-lg navbar-light bg-light">
			<a class="navbar-brand" href="#"><img
				src="<c:url value="/LogoFish.svg"/>" height="40" width="40"></a>
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav mr-auto">
					<li class="nav-item active"><a class="nav-link"
						href="<c:url value="/collaborateurs/lister"/>">Collaborateurs
		...
		<div class="col align-self-start mr-3">
			<div class="text-right">
				<button class="btn btn-primary" id="btnAdd">
					<a href="<c:url value="/collaborateurs/creer"/>">Ajouter
	...
	<div class="container-fluid">
		...
		<form name="searchCollab"
			action="<c:url value="/collaborateurs/chercher"/>"
			method="post">
			<div class="form-group row mt-2">
				<div
					class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-12 text-right">
					<label class="control-label" for="search1">Rechercher un
						nom ou un prénom qui commence par :</label>
				</div>
				<div
					class="col-12 col-xl-3 col-lg-3 col-md-4 col-sm-4 col-xs-12 mb-2">
					<input class="form-control" type="search" placeholder="Rechercher"
						aria-label="Rechercher" name="nomPrenom" id="search1">
				</div>
				<div
					class="col-12 col-xl-1 col-lg-1 col-md-2 col-sm-2 col-xs-12 mb-2">
					...
					<div class="form-check pl-0">
						<div class="custom-control custom-checkbox">
							<input type="checkbox" class="custom-control-input"
								...
								class="custom-control-label" for="defaultUnchecked">Voir
			...
			<div class="form-group row mt-2">
				<div
					class="col-12 col-xl-4 col-lg-4 col-md-4 col-sm-4 col-xs-12 text-right">
					<label class="control-label" for="controlSelect1">Filtrer
				...
				<div class="card mb-2">
					...
					<div class="card-footer">
						<div class="btn-edit text-right">
							<a href="<c:url value="/collaborateurs/editer?matricule=${c.matricule}"/>"
